...
# ─── Make sure our own modules live in src/ are importable ──────────────────────
...
# ─── Gemini Flash wrapper (must live in src/gemini_flash_beta_llm.py) ─────────
...
# ─── Bring in our SQL‐generation pieces ────────────────────────────────────────
...
def main():
    ...
    # ─── 3) Enter question (English or Other) ────────────────────────────────────
    ...
    # ─── 4) Generate SQL ────────────────────────────────────────────────────────
    mode = st.selectbox("3) Generation Mode",
    ...
    # ─── 6) Show results or updated schema ───────────────────────────────────────
    if "query_df" in st.session_state:
        ...
        st.graphviz_chart(
            render_er_diagram(st.session_state["schema_data_updated"])
        )
